...
public class Filial extends GenericEntity<Long> {
    ...
    @JsonIgnore
    private List<FilialEstoqueProduto> filialEstoqueProduto;

    public void addFilialEstoqueProduto(FilialEstoqueProduto filialEstoqueProdutoToAdd){
        filialEstoqueProduto.add(filialEstoqueProdutoToAdd);
    }
